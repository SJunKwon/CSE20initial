...
class SdNotificationScreen extends StatelessWidget {
  ...
  /// Navigates to the sdAttendanceOneScreen when the action is triggered.
  onTapThirtyFour(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.sdAttendanceOneScreen);
  }

  /// Navigates to the sdSettingsScreen when the action is triggered.
  onTapThirtyThree(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.sdSettingsScreen);
  }
}
